...
class FipfestRegisterPage extends StatefulWidget {
  const FipfestRegisterPage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<FipfestRegisterPage> createState() => _FipfestRegisterPageState();
}

class _FipfestRegisterPageState extends State<FipfestRegisterPage> {
