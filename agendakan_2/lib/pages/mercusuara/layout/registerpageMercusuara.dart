...
class RegisterPageMercusuara extends StatefulWidget {
  const RegisterPageMercusuara({Key? key, required this.title})
      : super(key: key);
  final String title;

  @override
  State<RegisterPageMercusuara> createState() => _RegisterPageStateMercusuara();
}

class _RegisterPageStateMercusuara extends State<RegisterPageMercusuara> {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          Get.toNamed("/mercusuara/loginpage");
                        },
