...
import 'package:agendakan_2/pages/mercusuara/controller/DataTableMercusuara.dart';
...
class TicketAdminMercusuara extends StatelessWidget {
  const TicketAdminMercusuara({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    final screenSize = MediaQuery.of(context).size.width;
    LoadDataControllerMercusuara _dataControl =
                                ...
                                Expanded(
                                    ...
                                    child: Scaffold(
                                        body: ChangeNotifierProvider<
                                            DataTableMercusuaraProvider>(
                                      create: (context) =>
                                          DataTableMercusuaraProvider(),
                                      child:
                                          Consumer<DataTableMercusuaraProvider>(
                                              builder:
                                                          ...
                                                          cells: [
                                                            ...
                                                            DataCell(
                                                              ...
                                                              onTap: () async {
                                                                ...
                                                                //             .toString());
                                                                Get.toNamed(
                                                                    "/mercusuara/ticket/detailsAdmin",
                                                                    arguments: element[
                                                                            'id']
                                                                        .toString());
