...
import 'package:agendakan_2/pages/dashboard/widgets/top_nav%20copy.dart';
...
import 'package:agendakan_2/pages/mercusuara/controller/LoadDataMercusuara.dart';
...
class ticketDetailsMercusuaraPage extends StatefulWidget {
  const ticketDetailsMercusuaraPage({Key? key, required this.title})
      : super(key: key);
  final String title;

  @override
  State<ticketDetailsMercusuaraPage> createState() =>
      _ticketDetailsMercusuaraPageState();
}
...
class _ticketDetailsMercusuaraPageState
    extends State<ticketDetailsMercusuaraPage> {
  @override
  Widget build(BuildContext context) {
    ...
    final LoadDataControllerMercusuara dataControl =
        Get.put(LoadDataControllerMercusuara());
    final LoadImageControllerMercusuara imageControl =
        Get.put(LoadImageControllerMercusuara());
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                              "Jika mengalami kendala, silahkan menghubungi Contact Person kami di: +6281214376362 (WA message only)"),
                                        ),
                                      ],
                                    ),
                                    SizedBox(
                                                    ...
                                                    onPressed: (() async {
                                                      ...
                                                      html.AnchorElement
                                                          ...
                                                          new html.AnchorElement(
                                                              href: "https://mercusuara.agendakan.com/storage/pdf/E-Ticket(" +
                                                                  dataControl.data[
                                                                          'data']
                                                                      [
                                                                      'kode_pembelian'] +
                                                      ...
                                                      anchorElement.download =
                                                          "https://mercusuara.agendakan.com/storage/pdf/E-Ticket(" +
                                                              dataControl.data[
                                                                      'data'][
                                                                  'kode_pembelian'] +
                                                              ").pdf";
                                                      ...
                                                      content: Container(
                                                        ...
                                                        decoration: BoxDecoration(
                                                            image: DecorationImage(
                                                                image: NetworkImage(
                                                                    "https://mercusuara.agendakan.com/api/mercusuara/get-bukti/" +
                                                                        dataControl.data['data']
                                                                            [
                                                                            'bukti_pembayaran']),
                                                                fit: BoxFit
                                                        ...
                                                        onTap: () {
                                                          Get.defaultDialog(
                                                            ...
                                                            content: Container(
                                                              ...
                                                              decoration: BoxDecoration(
                                                                  image: DecorationImage(
                                                                      image: NetworkImage("https://mercusuara.agendakan.com/api/mercusuara/get-bukti/" +
                                                                          imageControl
                                                                              .linkFile),
                                                                      fit: BoxFit
                                                                          .fill)),
                                                                ...
                                                                SingleChildScrollView(
                                                                  child: Column(
                                                                      children: [
                                                                        ...
                                                                        //                   width: 10,
                                                                        //                 ),
                                                                        //                 Text(dataControl.data["data"]["total_pajak"].toString())
                                                                        //               ]),
                                                                        //             ),
                                                                        //           ],
                                                                        //         ))
                                                                                      ...
                                                                                      if (dataControl.data['data']['status_pembelian'] == "approved") ...[
                                                                                        ElevatedButton(
                                                                                            onPressed: (() async {
                                                                                              ...
                                                                                              html.AnchorElement anchorElement = new html.AnchorElement(href: "https://mercusuara.agendakan.com/storage/pdf/E-Ticket(" + dataControl.data['data']['kode_pembelian'] + ").pdf");
                                                                                              anchorElement.download = "https://mercusuara.agendakan.com/storage/pdf/E-Ticket(" + dataControl.data['data']['kode_pembelian'] + ").pdf";
                                                                                              anchorElement.click();
                                                                                            }),
                                                                                          ...
                                                                                          onTap: () {
                                                                                            Get.defaultDialog(
                                                                                              ...
                                                                                              content: Container(
                                                                                                ...
                                                                                                decoration: BoxDecoration(image: DecorationImage(image: NetworkImage("https://mercusuara.agendakan.com/api/mercusuara/get-bukti/" + dataControl.data['data']['bukti_pembayaran']), fit: BoxFit.fill)),
                                                                                              ),
                                                                                            );
                                                                                          },
                                                                                          child: Container(
                                                                                                ...
                                                                                                onTap: () {
                                                                                                  Get.defaultDialog(
                                                                                                    ...
                                                                                                    content: Container(
                                                                                                      height: MediaQuery.of(context).size.height / 2,
                                                                                                      width: MediaQuery.of(context).size.width / 2,
                                                                                                      decoration: BoxDecoration(image: DecorationImage(image: NetworkImage("https://mercusuara.agendakan.com/api/mercusuara/get-bukti/" + imageControl.linkFile), fit: BoxFit.fill)),
                                                                                                    ),
                                                                                                  );
                                                                                                },
                                                                                                child: Container(
