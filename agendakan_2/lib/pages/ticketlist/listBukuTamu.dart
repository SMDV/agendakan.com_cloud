...
class ListBukuTamu extends StatefulWidget {
  const ListBukuTamu({Key? key}) : super(key: key);

  @override
  State<ListBukuTamu> createState() => _ListBukuTamuState();
}

class _ListBukuTamuState extends State<ListBukuTamu> {
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text("Status Kehadiran",
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                  Text(_data[index]['status_kehadiran'].toString()),
                  SizedBox(
                    height: 10,
                  ),
