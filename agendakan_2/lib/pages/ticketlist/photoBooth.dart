...
class PhotoBooth extends StatefulWidget {
  const PhotoBooth({Key? key}) : super(key: key);
...
class GetDataController extends GetxController with StateMixin {
  ...
  void loadDataKategori(String keyword) async {
    change(null, status: RxStatus.loading());
    var apiData = await _provider.get10("foto");
    if (apiData["data"] == null) {
      change(null, status: RxStatus.empty());
    } else {
      _data = apiData["data"];
...
class MyData extends DataTableSource {
  ...
  DataRow getRow(int index) {
    ...
    return DataRow(cells: [
      ...
      DataCell(Text((_data[index]['tanggal_foto'] == null)
          ? "Belum diambil"
          : "Sudah diambil")),
      DataCell(Text(_data[index]['tanggal_foto'].toString())),
              ...
              content: Column(
                ...
                children: [
                  ...
                  Text("Status Pengambilan",
                      style:
                          TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
                  Text((_data[index]['tanggal_foto'] == null)
                      ? "Belum diambil"
                      : "Sudah diambil"),
                  SizedBox(
                    height: 10,
                  ),
                  if (_data[index]['tanggal_foto'] == null) ...[
                    SizedBox(
                      height: 20,
                    ),
                    ...
                    Text(_data[index]['tanggal_foto'].toString()),
                    SizedBox(
                      height: 10,
                    ),
                  ],
