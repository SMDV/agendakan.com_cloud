...
import 'package:agendakan_2/pages/weekfest/controller/register_page.dart';
import 'package:agendakan_2/pages/weekfest/repository/weekfest_api.dart';
...
class WeekFesLoginPage extends StatefulWidget {
  const WeekFesLoginPage({Key? key, required this.title}) : super(key: key);
  final String title;

  @override
  State<WeekFesLoginPage> createState() => _WeekFesLoginPageState();
}

class _WeekFesLoginPageState extends State<WeekFesLoginPage> {
                      ...
                      TextButton(
                        onPressed: () {
                          Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const WeekfestRegisterPage(
                                  title: 'Register UI'),
                            ),
                          );
                        },
