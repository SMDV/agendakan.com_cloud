...
class WeekFest_API {
  ...
  final String _baseUrl = "https://weekfest.agendakan.com";
  ...
  Future<dynamic> post(String email, String password) async {
    ...
    if (responseJson != null) {
      ...
      if (responseJson['acara'] == "WEEKFEST") {
        ...
        if (responseJson['isAdmin'] == 1) {
          ...
          Get.toNamed('/weekfest', arguments: responseJson['token']);
        }
      }
    } else {
      print("Login Failed!");
    ...
    switch (response.statusCode) {
      ...
      case 400:
        ...
        Get.defaultDialog(content: Text("Email atau Password Salah!"))
            .then((value) => Get.offAllNamed("/weekfest/loginpage"));
        return null;
      case 401:
      ...
      case 409:
        ...
        Get.defaultDialog(
            ...
            .then((value) => Get.offAllNamed("/weekfest/ticket_list"));
        return null;
      ...
      case 422:
        ...
        if (responseJson['message']['nomor_ktp'] != null) {
          ...
          Get.defaultDialog(
              ...
              .then((value) => Get.offAllNamed("/weekfest"));
        } else {
