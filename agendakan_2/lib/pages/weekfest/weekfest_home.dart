...
class WeekFestHome extends StatefulWidget {
  const WeekFestHome({Key? key}) : super(key: key);

  @override
  State<WeekFestHome> createState() => _WeekFestHome_HomeState();
}

class _WeekFestHome_HomeState extends State<WeekFestHome> {
            ...
            if (data_store.read("token") != null) ...[
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    if (data_store.read("isAdmin") == 1) {
                      Get.offAndToNamed('/weekfest/ticket_list');
                    } else {
                      Get.offAndToNamed('/weekfest/ticket_list');
                    }
                  },
              ...
              Container(
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Get.offAllNamed("/weekfest/loginpage");
                  },
                ),
              ),
            ],
        ...
        child: Column(children: [
              ...
              child: Row(
                children: [
                  ...
                  if (data_store.read("token") != null) ...[
                    InkWell(
                      ...
                      onTap: () {
                        if (data_store.read("isAdmin") == 1) {
                          ...
                          Get.toNamed('/weekfest/ticket_list');
                        }
                      },
                    ),
                    SizedBox(
                    ...
                    InkWell(
                      onTap: () {
                        Get.toNamed("/weekfest/registerpage");
                      },
                      child: Container(
                        height: 40,
                        width: 100,
          ...
          Container(
            child: CarouselSlider(
                items: [
                  'images/weekfest_carausel_1.png',
          ...
          AspectRatio(
            ...
            child: Row(children: [
              Container(
                ...
                child:
                    Image(image: AssetImage("images/weekfest_desc_left.png")),
              ...
              Container(
                child: Image(
                    image:
                        AssetImage("images/weekfest_date_location_right.png")),
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  ...
                                  // height: MediaQuery.of(context).size.width / 8,
                                  child: Image(
                                    image: AssetImage("images/weekfest_p1.png"),
                                    fit: BoxFit.fitHeight,
                                  ),
                                  //kalo sudah sold out
                                  // child: Image(
                  ...
                  children: [
                    ...
                    InkWell(
                      onTap: () async {
                        ...
                        dynamic data = await _provider.get7();
                        print(data['bundling']);
                        if (data['bundling'] != "tutup") {
                          final data_store = GetStorage();
                          if (data_store.read("token") != null) {
                            data_store.write("jenis_tiket", "bundling");
                            Get.toNamed("/weekfest/ticket_form");
                          } else {
                            Get.toNamed("/weekfest/loginpage");
                          }
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                // height: MediaQuery.of(context).size.width / 8,
                                child: Image(
                                  image: AssetImage("images/weekfest_p2.png"),
                                  fit: BoxFit.fitHeight,
                                ),
                                decoration: BoxDecoration(
                                    // color: Colors.black.withOpacity(0.85),
                                    // image: DecorationImage(
                                    //     image: AssetImage("images/gkm_.png"))
                                    ),
                              ),
                              Spacer(),
                            ],
                  ...
                  Column(
                    children: [
                      ...
                      Container(
                        ...
                        height: 55,
                        child: Image(
                          image: AssetImage("images/weekfest_logo.png"),
                          fit: BoxFit.fill,
                        ),
                      ),
                      SizedBox(
                          ...
                          InkWell(
                            onTap: () async {
                              if (await canLaunchUrl(Uri.parse(
                                  "https://instagram.com/weekfestfeb_?igshid=YmMyMTA2M2Y="))) {
                          ...
                          InkWell(
                            onTap: () async {
                              if (await canLaunchUrl(
                                  Uri.parse("https://wa.me/6285854454249"))) {
                                await launchUrl(
                                    Uri.parse("https://wa.me/6285854454249"));
                              } else {
                                throw 'Could not launch insta';
